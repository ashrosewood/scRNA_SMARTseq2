...
rule all:
    input:
       expand("samples/trimmed/{sample}_R1.fastq.gz_trimming_report.txt", sample = SAMPLES),
       expand("samples/trimmed/{sample}_R2.fastq.gz_trimming_report.txt", sample = SAMPLES),
