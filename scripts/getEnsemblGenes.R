...
gene_file <- paste0(dirname(outfile), "/gene_metadata.tsv")
...
gene_file <- paste0("/home/groups/CEDAR/woodfin/projects/NMT-seq/20190523_NM/anno/hg19", "/gene_hg19.cellRanger_metadata.tsv")
